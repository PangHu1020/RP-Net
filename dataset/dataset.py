...
from utils.transform import  DiffractionNoise, DiffuseNoise
...
if args.is_recons:
     ls_transform = transforms.Compose([
        ...
        # DiffractionNoise(radius=40, noise_scale=0.9), 
        # DiffuseNoise(noise_scale=0.9, kernel_size=25),
        DiffractionNoise(radius=200, noise_scale=0.1), 
        DiffuseNoise(noise_scale=0.8, kernel_size=25),
